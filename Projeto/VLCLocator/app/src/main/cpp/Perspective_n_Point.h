...
//#ifndef VLC_LOCATOR_PERSPECTIVE_N_POINT_H
//#define VLC_LOCATOR_PERSPECTIVE_N_POINT_H
#ifndef PERSPECTIVE_N_POINT_H
#define PERSPECTIVE_N_POINT_H
...
#endif //VLC_LOCATOR_PERSPECTIVE_N_POINT_H
